<template>
  <div class="relative">
    ...
    <div v-show="allElectronics.length < 3" class="toppicks bg-gray-200 flex items-center justify-center font-bold">
...
export default {
    name: 'Electronics',
    computed:{
        ...mapGetters(['allElectronics'])
    },
    methods:{
        ...mapActions(['fetchElectronics']),
    },
    created(){
